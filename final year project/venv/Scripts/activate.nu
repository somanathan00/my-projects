...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\python 100 days bootcamp\final year project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\python 100 days bootcamp\final year project\venv\Scripts\deactivate.nu'
